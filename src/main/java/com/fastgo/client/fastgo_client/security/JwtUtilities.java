package com.fastgo.client.fastgo_client.security;

import io.jsonwebtoken.Claims;
import io.jsonwebtoken.Jwts;
import io.jsonwebtoken.SignatureAlgorithm;

import com.fastgo.client.fastgo_client.domain.Role;
...
import static com.fastgo.client.fastgo_client.security.SecurityConstants.JWT_SECRET;
...
public class JwtUtilities {
    ...
    public boolean hasRoleClient(String token) {
        Claims claims = extractAllClaims(token);
        String role = (String) claims.get("role");
